export const config = {
  ...
  messages: {
    ...
    thereWereValidationErrors:
      'Hay errores de validación. Compruébelos a continuación.',
    forbiddenError:
      'No puede realizar la acción {{actionName}} en {{resourceId}}',
    anyForbiddenError: 'No puede realizar la acción dada',
    successfullyCreated: 'Se creó con éxito un nuevo registro',
    bulkDeleteError:
      'Hubo un error al eliminar los registros. Consulte la consola para ver más información.',
    errorFetchingRecords:
      'Se produjo un error al obtener registros. Consulte la consola para ver más información.',
    errorFetchingRecord:
      'Hubo un error al obtener el registro. Consulta la consola para ver más información.',
    ...
    error404Resource:
      'Recurso de identificación dada: {{resourceId}} no pudo ser encontrado',
    error404Action:
      'Recurso de identificación dada: {{resourceId}} no tiene una acción con nombre: {{actionName}} ¡o usted no está autorizado a usarlo!',
    error404Record:
      'Recurso de identificación dada: {{resourceId}} no tiene registro con id: {{recordId}} ¡o usted no está autorizado a usarlo!',
    seeConsoleForMore:
      'Consulte la consola de desarrollo para obtener más detalles...',
    noActionComponent:
      'Tienes que implementar el componente de acción para tu Acción',
    ...
    customizeResources_subtitle:
      'Definición de comportamiento, adición de propiedades y más...',
    customizeActions_title: 'Personalizar acciones',
    customizeActions_subtitle:
      'Modificación de acciones existentes y adición de nuevas',
    ...
    customDashboard_subtitle:
      'Cómo modificar esta vista y agregar nuevas páginas en la barra lateral',
    ...
    community_subtitle:
      'Hable con los creadores de AdminJS y otros usuarios de AdminJS',
    ...
    needMoreSolutions_subtitle:
      'Estamos aquí para brindarle un hermoso diseño de UX/UI y un software personalizado basado (no solo) en AdminJS',
    ...
    keyValuePropertyDefaultDescription:
      'Todos los valores se almacenan como texto. ',
    ...
    componentNotFound_subtitle:
      'Tienes que especificar el componente que representará este elemento.',
  },
}
